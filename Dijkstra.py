"""
	...
	во взвешанном графе. 
	1) Функция dijkstra(G, start) возвращает словарь пар {ключ: значение},
	где ключ - это вершина, значение - это кратчайшее расстояние до этой вершины. 
	2) Функция recover_way(G,weights,start,finish) возвращает путь от start до finish (в обратную сторону)
	в виде строки
"""
import myDeque
import DFS
